...
/*   Updated: 2022/11/07 13:36:43 by cpollito         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	...
	Energy = 10;
	attackDamage = 0;
	std::cout<<"Default constructor ClapTrap" << getName() << std::endl;
}
...
ClapTrap::~ClapTrap(){ std::cout << "Destructor called" << getName() << std::endl; }
